...
class RegAndTranser:
    ...
    def process(self,image1):
        # 1. 检测文本框
        #image_o, image_b, text_boxes ,type= self.my_detect_text_boxes(image1)
        ...
        if cnts:
            ...
            rect.append( 0,0,img.shape[1],img.shape[0])
        ...
        # extracted_texts = self.extract_text_from_boxes(img_o, rect)
